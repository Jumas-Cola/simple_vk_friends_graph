...
class Drawer(object):
    ...
    def getRGBfromI(RGBint, scale=5, red=115, blue=218):
        # scale масштаб (RGBint*scale) < 255
        green = RGBint*scale & 255
    ...
    def draw_with_colors(self):
        ...
        for node in self.graph:
            ...
            color_map.append('#%02x%02x%02x' % Drawer.getRGBfromI(power))
        options = {
...
class Parser:
    ...
    def mutual_friends_with_colors(user_id=0):
        ...
        for friend in friends_info:
            ...
            friend_last_name = friend['last_name']
            friend_id = str(friend['id'])
            node = '{}/{}/{}/{}:{}/{}/{}/{}:'.format(person_name,person_last_name,person_id,0,friend_name,friend_last_name,friend_id,powers[friend_id])+'{}\n'
            f.write(node)
            try:
                ...
                for mutual in mutuals_info:
                    ...
                    node = '{}/{}/{}/{}:{}/{}/{}/{}:'.format(friend_name,friend_last_name,friend_id,powers[friend_id],mutual_name,mutual_last_name,mutual_id,powers[mutual_id])+'{}\n'
                    f.write(node)
            except:
